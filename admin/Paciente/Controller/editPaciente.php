...
$id = isset($_POST['pacienteId']) ? $_POST['pacienteId'] : null;
...
if ($senhas) {
    $senha = sha1($senhas);
    $metodo->editPacienteComSenha($id, $nome,$cpf_cpnj,$data_nasc,$nome_responsavel,$telefone,$telefone_s,$rg_ie,$nome_pai,$nome_mae,$email,
        $senha,$indicacao_dr, $nome_empresa,$telefone_empresa,$profissao,$horario_trabalho,$cargo,$naturalidade,$nacionalidade,$estado_civil,
        $nome_conjuge,$sexo);
}else{
    $metodo->editPaciente($id, $nome,$cpf_cpnj,$data_nasc,$nome_responsavel,$telefone,$telefone_s,$rg_ie,$nome_pai,$nome_mae,$email, $indicacao_dr,
