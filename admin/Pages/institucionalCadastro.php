...
<form action="../admin/Institucional/Controller/addInstitucional.php" method="post" enctype="multipart/form-data">

    <header>
        <h2>Cadastro Institucional</h2>
        <div>Insira as informações.</div><br/>
    </header>

    <div>
        <label class="desc" id="descricao" for="descricao">Título*</label>
        <div>
            <input id="descricao" name="descricao" type="text" class="field text fn" value="" size="45" tabindex="1" placeholder="Missão" required="required">
        </div>
    </div>
